...
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : M0.M0.mexp) in
    Obj.repr(
# 33 "parser.mly"
                  (_1)
# 206 "parser.ml"
               : M0.M0.mexp))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 1 : M0.M0.mexp) in
    Obj.repr(
# 36 "parser.mly"
               (_2)
# 213 "parser.ml"
...
; (fun __caml_parser_env ->
    ...
    let _4 = (Parsing.peek_val __caml_parser_env 0 : M0.M0.mexp) in
    Obj.repr(
# 39 "parser.mly"
                      (M0.M0.Fn(_2,_4))
# 235 "parser.ml"
...
; (fun __caml_parser_env ->
    ...
    let _5 = (Parsing.peek_val __caml_parser_env 0 : M0.M0.mexp) in
    Obj.repr(
# 40 "parser.mly"
                          (M0.M0.Rec(_2, _3, _5))
# 244 "parser.ml"
...
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : M0.M0.mexp) in
    let _2 = (Parsing.peek_val __caml_parser_env 0 : M0.M0.mexp) in
    Obj.repr(
# 41 "parser.mly"
                        (M0.M0.App(_1,_2))
# 252 "parser.ml"
               : M0.M0.mexp))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : M0.M0.mexp) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : M0.M0.mexp) in
    Obj.repr(
# 42 "parser.mly"
                   (M0.M0.Add(_1,_3))
# 260 "parser.ml"
...
# 284 "parser.ml"
               : M0.M0.mexp))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 4 : M0.M0.mexp) in
    let _4 = (Parsing.peek_val __caml_parser_env 2 : M0.M0.mexp) in
    let _6 = (Parsing.peek_val __caml_parser_env 0 : M0.M0.mexp) in
    Obj.repr(
# 46 "parser.mly"
                                (M0.M0.Ifz(_2,_4,_6))
# 293 "parser.ml"
               : M0.M0.mexp))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 3 : M0.M0.mexp) in
    let _4 = (Parsing.peek_val __caml_parser_env 1 : M0.M0.mexp) in
    Obj.repr(
# 47 "parser.mly"
                          (M0.M0.Pair (_2, _4))
# 301 "parser.ml"
...
let program (lexfun : Lexing.lexbuf -> token) (lexbuf : Lexing.lexbuf) =
   (Parsing.yyparse yytables 1 lexfun lexbuf : M0.M0.mexp)
;;
